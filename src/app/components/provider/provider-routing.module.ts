...
import {AddReviewClientComponent} from '../client/add-review-client/add-review-client.component';
...
const routes = [
  ...
  {
    path: 'provider/review/add-review',
    component: AddReviewProviderComponent
  },
  {
    path: 'provider/jobs',
    component: ProviderJobsComponent
